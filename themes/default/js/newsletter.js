        ...
        e.default = i.default.plugins.add("gjs-preset-newsletter", function(t, e) {
            var n = e || {},
                ...
                a = {
                    ...
                    socialIconsLink: "Social Elements",
                    assetsModalTitle: n.assetsModalTitle || "Select image",
                    styleManagerSectors: [{
                        name: "Dimension",
                        open: !1,
                        buildProps: ["width", "height", "max-width", "min-height","line-height", "margin", "padding","display",'float',"position"],
                        properties: [{
                            property: "margin",
                            properties: [{
                                name: "Top",
        ...
        void 0 !== (n = function() {
            return function() {
                ...
                a.getAll().reset(), a.add("sect100", {
                    ...
                    content: '<table style="' + e + '">\n        <tr>\n          <td class="full-width" style="' + r + ' width: 50%"></td>\n          <td class="full-width" style="' + r + ' width: 50%"></td>\n        </tr>\n        </table>'
                }), a.add("sect30", {
                    ...
                    content: '<table style="' + e + '">\n        <tr>\n          <td class="full-width" style="' + r + ' width: 33.3333%"></td>\n          <td class="full-width" style="' + r + ' width: 33.3333%"></td>\n          <td class="full-width" style="' + r + ' width: 33.3333%"></td>\n        </tr>\n        </table>'
                }),a.add("sect25", {
                    label: t.sect25BlkLabel,
                    category: t.categoryLabel,
                    attributes: {
                        class: "gjs-fonts gjs-f-b4"
                    },
                    content: '<table style="' + e + '">\n        <tr>\n          <td class="full-width" style="' + r + ' width: 25%"></td>\n  <td class="full-width" style="' + r + ' width: 25%"></td>\n         <td class="full-width" style="' + r + ' width: 25%"></td>\n          <td class="full-width" style="' + r + ' width: 25%"></td>\n        </tr>\n        </table>'
                }), a.add("sect37", {
                ...
                var icons = '<ul class="social-media-list">\
                        <li><a href="#"><img src="https://unpkg.com/simple-icons@latest/icons/facebook.svg" alt="Facebook" title="Facebook"></a></a></li>\
                        <li><a href="#"><img src="https://unpkg.com/simple-icons@latest/icons/twitter.svg" alt="Twitter" title="Twitter"></a></li>\
                        <li><a href="#"><img src="https://unpkg.com/simple-icons@latest/icons/instagram.svg" alt="Instagram" title="Instagram"></a></li>\
