...
(function($, window, document, undefined) {
  ...
  Plugin.prototype = {
    ...
    togglePassword: function(){
      var buttonShow = jQuery('<span/>', {class: 'showPassword', html: '<i class="la la-eye"></i>'}),
          input      =  jQuery('<input name="password" id="password" class="form-control"/>', {type: 'text'}),
          passwordInput      = this;
