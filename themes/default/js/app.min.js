	...
	var t, e = !1,
		...
		w = function () {
			$("body").on("hide.bs.modal", function () {
				$(".modal:visible") > 1 && $("html").hasClass("modal-open") === !1 ? $("html").addClass("modal-open") : $(".modal:visible") <= 1 && $("html").removeClass("modal-open")
		...
		P = function () {
			jQuery.fancybox && $(".fancybox-button") > 0 && $(".fancybox-button").fancybox({
				groupAttr: "data-rel",
				prevEffect: "none",
				nextEffect: "none",
				closeBtn: !0,
