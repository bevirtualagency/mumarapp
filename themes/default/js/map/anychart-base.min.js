...
c.styleSheet?c.styleSheet.cssText=b:c.appendChild(window.document.createTextNode(String(b)));$.We($.ve(window.document,"head",void 0,void 0)[0],c,0);sE=!0}this.Sd||(this.Sd=$.Ke("DIV",""));this.i||(this.i=$.Ke("A"),this.D=$.Ke("SPAN",""),this.b=$.Ke("IMG",""),Ue(this.i,this.D),this.Sd.appendChild(this.i));b=this.f.Nl();this.J(jl)&&(b&&b.appendChild(this.Sd),this.I(jl));this.J(kl)&&(b=$.hc.apply(null,[", v%s.%s.%s.%s"].concat(["8","10","0",
"1933"])),c=a?this.QJ():"",$.xe(this.i,{href:a?this.SJ():"",title:c.replace("",b)}),$.xe(this.b,{alt:a?this.RJ():""}),this.I(kl));this.J(ll)&&(a=a?this.text():"",$.df(this.D,a),this.I(ll));if(this.J(ml)){if(a=ql(this)?this.iF():ol()){if(this.P=a,b=ph($.kg()))$.Id(b,"complete",this.w3,!1,
...
XF={"select-marquee-start":{index:9.3,text:"Start selection marquee",eventType:"anychart.startSelectMarquee",action:function(a){a.menuParent.QO(!1)}},"save-chart-as":{index:10,text:"",iconClass:"",subMenu:{}},"save-data-as":{index:20,text:"Save data as...",iconClass:"ac ac-save",subMenu:{"save-data-as-text":{index:10,text:".csv",iconClass:"ac ac-file-excel-o",eventType:"anychart.saveAsCsv",action:function(a){a.menuParent.Ty()}},
