...
<link href="/themes/default/css/map/anychart-ui.min.css?v={{$local_version}}" rel="stylesheet" type="text/css">
<link href="/themes/default/css/map/anychart-font.min.css?v={{$local_version}}" rel="stylesheet" type="text/css">
@endsection
@php
...
@if (Session::has('msg'))
<div class="alert alert-success" data-name="eOhsIAko">
    {{ Session::get('msg') }}
</div>
@endif
<div id="msg" class="display-hide" data-name="jGJSkCvZ">
    <button class="close" data-close="alert"></button>
    <span id='msg-text'><span>
</div>
 
<div class="row" data-name="VEJdNJZv">    
    <div class="col-md-12" data-name="zJmSNpTt">
        <!-- BEGIN EXAMPLE TABLE PORTLET-->
        <div class="kt-portlet kt-portlet--height-fluid" data-name="YEmfsXqg">
            <div class="kt-portlet__head" data-name="aXbzqzjP">
                <div class="kt-portlet__head-label" data-name="BjArsrVM">
                ...
                <div class="kt-portlet__head-toolbar" data-name="mIvUpZlS">
					...
					@if(routeAccess('export_drip_stats'))
           ...
           <?php
           $openStats = routeAccess('get_trigger_open_stats');
           $clickStats = routeAccess('get_trigger_click_stats');
           $unsubStats = routeAccess('get_trigger_unsub_stats');
           $bounceStats = routeAccess('get_trigger_bounce_stats');
           $complaintStats = routeAccess('get_trigger_spam_stats');
           $broadcastLogs = routeAccess('get_trigger_log_stats');
           $campaignContent = routeAccess('get_trigger_ab_stats');
           ?>
            <div class="kt-portlet__body" data-name="cNILSEDI"> 
                <div class="" data-name="mtaKnpvm">
                    ...
                    <div class="tab-content" data-name="TmvOwYve">
                        @if($isDrip)
                            <div class="tab-pane active" id="tab1" data-name="DjQhzbGC">
                                <div class="form-group row" data-name="jvdwvjxJ">
                                    <div class="col-md-6" data-name="uVkODRha">
                                        <div class="table-scrollable">
                                            <table id="summery" class="table table-striped table-hover table-checkable">
                                                <tbody>
                                                <tr>
                                    ...
                                    <div class="col-md-6 por" data-name="wvARJuxv">
                                        <div class="row">
                                        ...
                                        @endif
                                            ...
                                            $openPercentage = 0;
                                            $unopened = 0;
                                            $total_emails = $campaign_sent;//($total_emails > 0)? $total_emails:$campaign_sent; 
                                            if($total_emails > 0){
                                        ...
                                        @endif
                                        <div class="kt-portlet kt-portlet--bordered" data-name="mAdGPCXX">
                                            <div class="kt-portlet__head" data-name="HAdbpgOP">
                                                <div class="kt-portlet__head-label" data-name="uJGIDdRB">
                                                    <h3 class="kt-portlet__head-title">
                                                        {{trans('common.stats.country_clicked')}}
                                                    </h3>
                                                </div>
                                            </div>
                                            <div class="kt-portlet__body relative" data-name="cMPfqiMW">
                                                ...
                                                <div id="regions_div" style="width: 100%; height: 300px;" data-name="FSrIqCmD"><img id="loaderImg" class="opensChart" src="/resources/assets/images/loader.gif"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @else
                          <div class="tab-pane active" id="tab1" data-name="YckheMAF">
                                <div class="form-group row" data-name="erEORbjv">
                                    <div class="col-md-6" data-name="mpNwvrdz">
                                        <div class="table-scrollable">
                                            <table id="summery" class="table table-striped table-hover table-checkable responsive">
                                                ...
                                                <tr>
                                                    <td> {{trans('statistics.detail.sending_time')}} </td>
                                                    <td>
                                                        <span class=""> {{ isset($campaign->start_datetime) ?  Carbon\Carbon::parse(convertUtctoCustomer(Auth::user()->id, $campaign->start_datetime))->format('M d, Y h:i:s A') : '---'}} </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td> {{trans('statistics.detail.finished_time')}} </td>
                                                    <td>
                                                        <span class=""> {{ ($campaign->end_datetime) && $campaign_sent >= $total_emails ? Carbon\Carbon::parse(convertUtctoCustomer(Auth::user()->id, $campaign->end_datetime))->format('M d, Y h:i:s A') : '---'}}</span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td> {{ trans('common.stats.skipped') }} </td>
                                                    <td>
                                                        <span class=""> {{ $skipped }} ({{number_format($skipped_percent , 2)}}%) @if($skipped > 0) <a class="skippedView" data-duplicate="{{$duplicates}}" data-suppressed_domains="{{$suppressed_domains}}" data-bounced="{{$campaign_bounced}}"  data-unsubscribed="{{$unsubscribed}}" data-in_active="{{$in_active}}" data-not_confirmed="{{$not_confirmed}}" data-suppressed="{{$suppressed}}" data-id="{{$campaign_schedule_id}}" href="javascript:void(0);"> <i class="la la-eye"></i> </a> @endif</span>
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="col-md-6 por" data-name="XTbUsDeJ">
                                        <div class="row">
                                            <div class="col-md-3 summary-stats">
                                                <div class="topevents">
                                                    <div class="icon">
...
<!--                                         Top domain Chart for the campaign-->                                        
                                            ...
                                            <div class="kt-portlet__body relative" data-name="DMLfwPjx">
                                                ...
                                                <div class="row ouc-blk">
                                                    <div class="col-md-6">
                                                        <div class="kt-widget14__legend">
                                                            <span class="kt-widget14__bullet kt-bg-success"></span>
                                                            <span class="kt-widget14__stats" style="">{{ $openPercentage }}% {{ $openPercentage }}% {{trans('common.status.span_opened_total')}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="kt-widget14__legend">
                                                            <span class="kt-widget14__bullet kt-bg-warning"></span>
                                                            <span class="kt-widget14__stats" style="">{{ $unopendEnd }}% {{ $unopendEnd }}% {{trans('common.status.span_unopen_total')}}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="progress">
                                        ...
                                        <div class="kt-portlet kt-portlet--bordered" data-name="LfhTPahO">
                                            <div class="kt-portlet__head" data-name="pulbEJJl">
                                                <div class="kt-portlet__head-label" data-name="eYoIxVXP">
                                                    <h3 class="kt-portlet__head-title">
                                                       {{trans('common.stats.sent')}}
                                                    </h3>
                                                </div>
                                            </div>
                                            <div class="kt-portlet__body relative" data-name="tdJPrWqZ">
                                                <script type="text/javascript">
                                                    function drawRegionsMap() {
                                                        var jsonData = $.ajax({
                                                ...
                                                <div id="regions_div" style="width: 100%; height: 300px;" data-name="gKAPHEIy"><img id="loaderImg" class="opensChart" src="/resources/assets/images/loader.gif"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @endif
                      @if($bounceStats)
                        <div class="tab-pane" id="tab2" data-name="jevNsMWk">
                      ...
                      @endif
                      @if($openStats)
                        <div class="tab-pane" id="tab3" data-name="XOSEfcJT">
                            <div class="dataTables_wrapper no-footer" data-name="fvHPWpYZ">
                                <div class="row opens_filter" style="padding-bottom: 15px; width:150px; padding-left: 10px;" data-name="SGmSZaVi" >
                      ...
                      @endif
                      @if($clickStats)
                        <div class="tab-pane" id="tab4" data-name="QUIurqpt">
                            ...
                            <div class="dataTables_wrapper no-footer" data-name="tvbvbKLQ">
                                <div class="row opens_filter" style="padding-bottom: 15px; width:150px; padding-left: 10px;" data-name="syjEUlDY" >
                      ...
                      @endif
                      @if($unsubStats)
                        <div class="tab-pane" id="tab5" data-name="ZScmqKpF">
                            <div class="table-scrollable col-md-12">
                      ...
                      @endif
                      @if($complaintStats)
                        <div class="tab-pane" id="tab6" data-name="GTgxdDxC">
                            <div class="table-scrollable col-md-12">
                      ...
                      @endif
                      <div class="tab-pane" id="tab7" data-name="ygYaaaBN">
                            <div class="dataTables_wrapper no-footer" data-name="rBmjErfj">
                        ...
                        <div class="tab-pane" id="tab8" data-name="owPatNzK">
                            <div class="table-scrollable col-md-12">
                        ...
                        <div class="tab-pane" id="tab9" data-name="bTpYTwYq">
                            <div class="dataTables_wrapper no-footer" data-name="GlmBZdny">
                                <div class="row" data-name="qdGLCqul">
                                    <div class="col-md-6" data-name="UEUAXxcT">
                                        <div class="kt-radio-inline" data-name="dKYOEiZC">
                       ...
                       <div id="campaign-list" class="modal" role="dialog" aria-hidden="true" data-name="XQHQlOhg">
                            <div class="modal-dialog" style="width: 700px;" data-name="ThBfoLLz">
                                <div class="modal-content" data-name="yCadIqGw">
                                <div class="modal-header" data-name="nMRRwcBb">
                                    ...
                                    <div class="modal-body" style="max-height: 500px;overflow-y:auto;" data-name="NxwtuBOB">
                        ...
                        <div id="contact-list" class="modal" role="dialog" aria-hidden="true" data-name="TjOYJtGV">
                            <div class="modal-dialog" style="width: 700px;" data-name="IJgHJgqu">
                                <div class="modal-content" data-name="brRmRREy">
                                <div class="modal-header" data-name="VowNUodn">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    ...
                                    <div class="modal-body" style="max-height: 500px;overflow-y:auto;" data-name="lkSYygsw">
                        ...
                        <div id="smtp-list" class="modal" role="dialog" aria-hidden="true" data-name="FAxlkCEg">
                            <div class="modal-dialog" style="width: 700px;" data-name="jjEemPXe">
                                <div class="modal-content" data-name="IGtLnwYA">
                                <div class="modal-header" data-name="wlLixqEK">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    ...
                                    <div class="modal-body" style="max-height: 500px;overflow-y:auto;" data-name="iHxlHljn">
                                        <div class="table-scrollable">
                        ...
                        <div id="from-smtp" class="modal" role="dialog" aria-hidden="true" data-name="PoBEiDsy">
                            <div class="modal-dialog" style="width: 900px;" data-name="NTnGvvUV">
                                <div class="modal-content" data-name="fKhURfjS">
                                <div class="modal-header" data-name="nBWZKYfL">
                                    ...
                                    <div class="modal-body" style="max-height: 500px;overflow-y:auto;" data-name="uNoqSDNt">
...
<div id="modal-subscriber-details" class="modal" role="dialog" aria-hidden="true" data-name="VZKdiuaZ">
    <div class="modal-dialog" style="width: 500px;" data-name="pHbRhuHT">
        <div class="modal-content" data-name="xEVBFHFO">
            <div class="modal-header" data-name="Sajhaqcv">
                <h5 class="modal-title">{{trans('statistics.modal.contact_details')}}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            </div>
            <div class="modal-body" data-name="LwuPpxtR">
                <form action="#" method="POST" class="form-horizontal">
                    <div class="subscriber-data" id="subscriber-data" data-name="TxybAhhP"></div>
                </form>
            </div>
        </div>
    </div>
...
<!-- skippedModal -->
<div class="modal fade" id="skippedModal" role="dialog" data-name="SvlNEwka">
    <div class="modal-dialog" data-name="dkCzscRG">
    <!-- Modal content-->
    <div class="modal-content" data-name="EvoOmkAi">
        <div class="modal-header" data-name="CAdXVWhy">
        <h5 class="modal-title">{{ trans('statistics.modal.skipped_details') }}</h5>
        <button type="button" class="close" data-dismiss="modal"></button>
        </div>
        <div class="modal-body" data-name="XxbGMMkY">
            <table class="table table-striped table-hover table-checkable responsive"  role="grid" >
                <tbody>
                    ...
                    <tr> 
                        <td> {{ trans('common.labe.inactive') }}  </td>
        ...
        <div class="modal-footer" data-name="hNFOzqEA">
