...
<link href="/resources/assets/css/schedule-create.css?v={{$local_version}}" rel="stylesheet" type="text/css">
<style>
    ...
    .admin_filter label.text-left {
        min-width: 180px;
    }
    #unsubscribe_header_row .lshapeBlk {
    left: 0;
    }
</style>
<script>
...
<script src="/themes/default/js/includes/schedule_evergreen.js?id=1222" type="text/javascript"></script>
...
<script>
    ...
    $("#segmentList").keyup(function(){
        ...
        if(str.length>0)
        {
            ...
            broadcast_arr.push({"id":"{{$campaign_metadata['id']}}","name":"{{strtoupper($campaign_metadata['name'])}}"});
            @endforeach
            @endforeach
    ...
    $(document).ready(function() {
       ...
       <?php  } ?>
        ...
        <?php 
            $evergreen_schedule_sending_time = convertUtctoCustomer(Auth::user()->id, $evergreen_campaign->evergreen_schedule_sending_time);
        ?>
        $('#sending_time').timepicker('setTime', "<?php echo date("H:i" , strtotime($evergreen_schedule_sending_time)); ?>");
        ...
        <?php if(isset($campaign_data['type']) && $campaign_data['type'] == 'evergreen') { ?>
            $("#type").click();
            getSegmentList();
        <?php } ?>
    ...
    <?php  if(!empty($campaign_data["campaign_type"]) and $campaign_data["campaign_type"] == "evergreen") { ?>
   ...
   loadEvergreenScheduleData (evergreen);
    ...
    <?php 
        if(!empty($evergreen_campaign) and !empty($evergreen_campaign->evergreen_schedule)) { 
    ?>
    loadEvergreenScheduleData("<?php echo $evergreen_campaign->evergreen_schedule; ?>");
    <?php } ?>
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit" data-name="meYuWaef">
                        <div class="kt-grid" data-name="KSJkzraP">
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper" data-name="Loymyrjl">
                                <form action="{{ route('update.evergreen') }}" class="kt-form kt-form--label-right" id="submit_form" method="POST">
                                                    ...
                                                    <div class="kt-form__section kt-form__section--first" data-name="sffiuOlN">
                                                        <div class="kt-wizard-v4__form" data-name="GJXFwUKv">
                                                            <div class="form-group row" data-name="zYRKkCYQ">
                                                                ...
                                                                <div class="col-md-12" data-name="jTewVYLm">
                                                                    <label class="col-form-label">{{trans('schedule_broadcast.add_new.tab1.form.schedule_label')}}
                                                                        ...
                                                                        {!! popover( 'schedule_broadcast.add_new.tab1.form.schedule_label_help','schedule_broadcast.add_new.tab1.form.schedule_label' ) !!}
                                                                    </label>
                                                            ...
                                                            <div class="form-group row" data-name="JaPYQUKe">
                                                                ...
                                                                <div class="col-md-12" data-name="njYZAKTU">
                                                                    <label class="col-form-label">{{trans('schedule_broadcast.add_new.tab1.form.campaign_type')}} 
                                                                        ...
                                                                        <span class="required"> * </span>
                                                                         {!! popover( 'schedule_broadcast.add_new.tab1.form.campaign_type_help','schedule_broadcast.add_new.tab1.form.campaign_type' ) !!}
                                                                    </label>
                                                                    <select class="form-control m-select2" name="campaign_type" id="campaign_type" onChange="getSegmentList()"> >
                                                                    <option value="evergreen" selected>{{trans('common.label.evergreen')}}  </option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div id="subscriber" class="desc" data-name="nAlYnSry">
                                                                <div class="form-group row" data-name="NPZCiSLZ">
                                                                        
                                                                    <div class="col-md-12" data-name="VIdObadM">
                                                                        <label class="col-form-label" for="contactList">{{trans('common.label.contact_list')}} <span class="required"> * </span>
                                                                        </label>
                                                                        ...
                                                                        <div class="kt-portlet kt-portlet--height-fluid scroll scroll-200 bt0" data-name="BzAplZWM">
                                                                            <div class="kt-portlet__body scList" data-name="LzfGSJnm">
                                                                                ...
                                                                                @foreach ($list_tree as $group_metadata)
                                                                                    ...
                                                                                    @foreach ($group_metadata['children'] as $list_metadata)
                                                                                        <div id="flag_{{$list_metadata['id']}}" class="kt-checkbox-list @if($list_metadata['is_blocked'] or $list_metadata['total_subscriber'] <= 0) list-disabled @endif" style="padding-left: 20px;" data-name="ThFxEWzg">
                                                                                            <label for="l_{{$list_metadata['id']}}" class="kt-checkbox childList">
                                                                                                <input id="l_{{$list_metadata['id']}}" type="checkbox" value="{{ $list_metadata['id'] }}" name="list_ids[]" required class="group-subscriber-{{ $group_metadata['id'] }} campaigns" class="group-list-ids-tab1-{{ $group_metadata['id'] }} subscriber_list" {{ isset($campaign_data['list_ids']) && $list_metadata['is_blocked'] != 1 && in_array($list_metadata['id'], explode(',', $campaign_data['list_ids'])) ? 'checked' : '' }} @if($list_metadata['is_blocked'] or $list_metadata['total_subscriber'] <= 0) disabled="disabled" @endif> {{ $list_metadata['name'] }} @if($list_metadata['is_blocked']) <bar>(Blocked)</bar>@endif
                                                                                                <span></span>
                                                                                            </label>
                                                                                        </div>
                                                                                    @php
                                                            ...
                                                            <div id="segment" class="desc" style="display: none;" data-name="MjKBKjNb">
                                                                <div class="form-group row" data-name="HtBjiAYe">
                                                                                ...
                                                                                <input type="hidden" name="no_campaign" id="no_campaign" value="0" />
                                                                                    @if (routeAccess('broadcasts.add'))
                                                                                        <div data-name="XdXOoRbb">
                                                                                            ...
                                                                                            <a href="{{route('broadcasts.add')}}">{{trans('common.label.create_one_here')}}</a>
                                                                                        </div>
                                                                                    @endif
                                                                            @endif    
                                                                        ...
                                                                        <div class="kt-portlet kt-portlet--height-fluid scroll scroll-200" data-name="tIoccxBJ">
                                                                            <div class="kt-portlet__body scList" data-name="gfyDkdkt">
                                                                                @foreach ($list_tree as $group_metadata)
                                                                                    ...
                                                                                    @foreach ($group_metadata['children'] as $list_metadata)
                                                                                        <div class="kt-checkbox-list" style="padding-left: 20px;" data-name="lSJjlWgH">
                                                ...
                                                <div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current" data-name="bbWseZeb">
                                                    <div class="kt-form__section kt-form__section--first" data-name="TsuYfYFh">
                                                        <div class="kt-wizard-v4__form" data-name="VULLbhrP">
                                                            <div class="form-group row" data-name="OwaxRWbw">
                                                                ...
                                                                <div class="col-md-12" data-name="XSYxeDRG">
                                                                    <label class="col-form-label" for="searchSmtps">{{trans('schedule_broadcast.add_new.tab3.form.sender_list')}}
                                                                        <span class="required"> * </span>
                                                                        {!! popover( 'schedule_broadcast.add_new.tab3.form.sender_list_help','schedule_broadcast.add_new.tab3.form.sender_list' ) !!}
                                                                    </label>
                                                                    ...
                                                                    <div class="kt-portlet kt-portlet--height-fluid scroll scroll-200 bt0" data-name="HRhwwndv">
                                                                        <div class="kt-portlet__body scList" data-name="DOkbyihZ">
                                                                            ...
                                                                            @foreach ($smtp_tree as $group_metadata)
                                                                            <div class="input-icon right mhide" data-name="vTdUGIMz">
                                                                                <label for="{{ $group_metadata['id'] }}" class="kt-checkbox">
                                                                                ...
                                                                                @if($group_metadata['children'])
                                                                                    @foreach ($group_metadata['children'] as $smtp_metadata)
                                                                                    <div id="sm_{{$smtp_metadata['id']}}" style="padding-left: 20px;" data-name="suqJXVPq">
                                                            ...
                                                            <div class="form-group row rd" data-name="CAxsBVml">
                                                                ...
                                                                <div class="col-md-12" data-name="HSdRAxGY">
                                                                    <label class="col-form-label">{{trans('schedule_broadcast.add_new.tab3.form.smtp_sequence')}}
                                                                        {!! popover( 'schedule_broadcast.add_new.tab3.form.smtp_sequence_help','schedule_broadcast.add_new.tab3.form.smtp_sequence' ) !!}
                                                                    </label>
                                                            ...
                                                            <div class="form-group row rd" id="sending_pattern" data-name="aYyifPWp">
                                                                ...
                                                                <div class="col-md-12" data-name="SEjacbqb">
                                                                    <label class="col-form-label">{{trans('schedule_broadcast.add_new.tab3.form.smtp_selection')}}
                                                                         {!! popover( 'schedule_broadcast.add_new.tab3.form.smtp_selection_help','schedule_broadcast.add_new.tab3.form.smtp_selection' ) !!}
                                                                    </label>
                                                ...
                                                <div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current" data-name="DIEcXyeg">
                                                    <div class="kt-form__section kt-form__section--first" data-name="VpRjOWPA">
                                                            ...
                                                            <div id="regular-campaign" data-name="uKIblySm">
                                                                <div class="form-group row mb0" data-name="DoHUGCxQ">
                                                                    ...
                                                                    <div class="col-md-12" data-name="SLuemiBN">
                                                                        <label class="col-form-label">{{trans('schedule_broadcast.add_new.tab4.form.send_campaign')}}
                                                                            {!! popover( 'schedule_broadcast.add_new.tab4.form.send_campaign_help','schedule_broadcast.add_new.tab4.form.send_campaign' ) !!}
                                                                        </label>
                                                                ...
                                                                <div id="evergreen-campaign" style="display: none;" data-name="KUeJrJOW">
                                                                    <div class="form-group row" data-name="XunmEwRJ">
                                                                        <div class="col-md-12">
                                                                            <label class="col-form-label">{{trans('broadcasts.custom_criteria_blade.select_option_placeholder')}}</label>
                                                                        </div>
                                                                        <div class="col-md-12" data-name="JtjaUlPX">
                                                                            <div class="kt-radio-inline" data-name="jXpDbThH">
                                                                                <label for="yearly" class="kt-radio kt-radio--default">
                                                                                    <input type="radio" id="yearly" name="evergreen_schedule"  value="yearly" onclick="loadEvergreenScheduleData('yearly')" {{ (isset($evergreen_campaign->evergreen_schedule) && $evergreen_campaign->evergreen_schedule == 'yearly') ? 'checked' : '' }}> {{trans('Yearly')}}
                                                                                    <span></span>
                                                                                </label> 
                                                                                <label for="mnth" class="kt-radio kt-radio--default">
                                                                                    <input type="radio" id="mnth" name="evergreen_schedule"  value="monthly" onclick="loadEvergreenScheduleData('monthly')" {{ (isset($evergreen_campaign->evergreen_schedule) && $evergreen_campaign->evergreen_schedule == 'monthly') ? 'checked' : '' }}> {{trans('common.monthly')}}
                                                                                    <span></span>
                                                                                </label> 
                                                                                ...
                                                                                <label for="hrly" class="kt-radio kt-radio--default">
                                                                                    <input type="radio" id="hrly" name="evergreen_schedule" value="hourly" onclick="loadEvergreenScheduleData('hourly')" {{ (isset($evergreen_campaign->evergreen_schedule) && $evergreen_campaign->evergreen_schedule == 'hourly') ? 'checked' : '' }}> {{trans('common.hourly')}}
                                                                                    <span></span>
                                                                                </label>
                                                                    ...
                                                                    <div class="form-group row" id="evergreen_schedule_week" data-name="jsUFFHVf">
                                                                        ...
                                                                        <div class="col-md-12" data-name="LTCHMDru">
                                                                            ...
                                                                            <select class="form-control m-select2" name="day_of_week" id="day_of_week">
                                                                                <option value="{{trans('common.sunday')}}" {{ (isset($evergreen_campaign->day_of_week) && $evergreen_campaign->day_of_week == trans('common.sunday')) ? 'selected' : '' }}>{{trans('common.sunday')}}</option>
                                                                                <option value="{{trans('common.monday')}}" {{ (isset($evergreen_campaign->day_of_week) && $evergreen_campaign->day_of_week == trans('common.monday')) ? 'selected' : '' }}>{{trans('common.monday')}}</option>
                                                                                <option value="{{trans('common.tuesday')}}" {{ (isset($evergreen_campaign->day_of_week) && $evergreen_campaign->day_of_week == trans('common.tuesday')) ? 'selected' : '' }}>{{trans('common.tuesday')}}</option>
                                                                                <option value="{{trans('common.wednesday')}}" {{ (isset($evergreen_campaign->day_of_week) && $evergreen_campaign->day_of_week == trans('common.wednesday')) ? 'selected' : '' }}>{{trans('common.wednesday')}}</option>
                                                                                <option value="{{trans('common.thursday')}}" {{ (isset($evergreen_campaign->day_of_week) && $evergreen_campaign->day_of_week == trans('common.thursday')) ? 'selected' : '' }}>{{trans('common.thursday')}}</option>
                                                                                <option value="{{trans('common.friday')}}" {{ (isset($evergreen_campaign->day_of_week) && $evergreen_campaign->day_of_week == trans('common.friday')) ? 'selected' : '' }}>{{trans('common.friday')}}</option>
                                                                                <option value="{{trans('common.saturday')}}" {{ (isset($evergreen_campaign->day_of_week) && $evergreen_campaign->day_of_week == trans('common.saturday')) ? 'selected' : '' }}>{{trans('common.saturday')}}</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row sending_timeInput" data-name="yohcpAfd">
                                                                        <div class="col-md-12" data-name="HCrWgXWq">
                                                                            ...
                                                                            <div class="input-group date" data-date-format="dd-mm-yyyy" data-name="MSRGAqTf">
                                                                                <input type="text" class="form-control timepicker timepicker-default" @if(!empty($evergreen_campaign->evergreen_schedule_sending_time)) value="{{$evergreen_schedule_sending_time}}" @endif name="evergreen_schedule_sending_time" id="sending_time">
                                                                    ...
                                                                    <div class="col-md-12" data-name="FyfuChNr">
                                                                        <label class="col-form-label">
                                                                            {{trans('schedule_broadcast.add_new.tab4.form.threads')}}
                                                                             {!! popover( 'schedule_broadcast.add_new.tab4.form.threads_help','schedule_broadcast.add_new.tab4.form.threads' ) !!}
                                                                        </label>
                                                                    ...
                                                                    <div class="col-md-12" data-name="NfayfMvD">
                                                                        <div class="row" data-name="emlmRFVE">
                                                                            <label class="col-form-label col-md-4 text-left">{{trans('schedule_broadcast.add_new.tab4.form.hourly_speed_limit')}}
                                                                                 {!! popover( 'schedule_broadcast.add_new.tab4.form.hourly_speed_limit_help','schedule_broadcast.add_new.tab4.form.hourly_speed_limit' ) !!}
                                                                            </label>
                                                                    ...
                                                                    <div class="col-md-12" data-name="MJDNAywm">
                                                                        <div class="row" data-name="BCkxRGFA">
                                                                            <label class="col-form-label col-md-4 text-left">{{trans('common.label.embed_unsubscribe_link')}}
                                                                                {!! popover( 'common.label.embed_unsubscribe_link_help','common.label.embed_unsubscribe_link' ) !!}
                                                                            </label>
                                                                    ...
                                                                    <div class="col-md-12" data-name="tKJUcXpU">
                                                                        <div class="row" data-name="nDYwCNJK">
                                                                            <label class="col-form-label col-md-4 text-left">{{trans('common.label.track_opens')}}
                                                                                 {!! popover( 'common.label.track_opens_help','common.label.track_opens' ) !!}
                                                                            </label>
                                                                    ...
                                                                    <div class="col-md-12" data-name="MmPzuIIx">
                                                                        <div class="row" data-name="gHpWEODG">
                                                                            <label class="col-form-label col-md-4 text-left">{{trans('common.label.track_clicks')}}
                                                                                {!! popover( 'common.label.track_clicks_help','common.label.track_clicks' ) !!}
                                                                            </label>
                                                               ...
                                                               <div class="form-group row" data-name="leGBttYg">
                                                                    <div class="col-md-12" data-name="zOBJflfY">
                                                                        <div class="row" data-name="zxUqgGTZ">
                                                                            <label class="col-form-label col-md-4 text-left">{{trans('schedule_broadcast.add_new.tab4.form.skip_duplicate')}}
                                                                                {!! popover( 'schedule_broadcast.add_new.tab4.form.skip_duplicate_help','schedule_broadcast.add_new.tab4.form.skip_duplicate' ) !!}
                                                                            </label>
                                                                    ...
                                                                    <div class="col-md-12" data-name="PoPnjsHN">
                                                                        <div class="row" data-name="MOseVyLY">
                                                                            <label class="col-form-label col-md-4 text-left">{{trans('schedule_broadcast.add_new.tab4.form.skip_unconfirmed')}}
                                                                                {!! popover( 'schedule_broadcast.add_new.tab4.form.skip_unconfirmed_desc','schedule_broadcast.add_new.tab4.form.skip_unconfirmed_desc' ) !!}
                                                                            </label>
                                                                    ...
                                                                    <div class="col-md-12" data-name="RYAFgSYC">
                                                                        <div class="row admin_filter mt0" data-name="TuIJeCUM">
                                                                            <label class="col-form-label col-md-4 text-left"> {{trans('common.label.unsubscribe_link')}}
                                                                                 {!! popover('common.label.unsubscribe_link_help','common.label.unsubscribe_link') !!}
                                                                            </label>
                                                                    ...
                                                                    <div class="col-md-12" data-name="POPGJgSR">
                                                                        <div class="row admin_filter mt0" data-name="mDKiJwgw">
                                                                            ...
                                                                            {{trans('common.label.unsubscribe_email')}} 
                                                                                 {!! popover('common.label.unsubscribe_email_help','common.label.unsubscribe_email') !!}
                                                                            </label>
                                                                ...
                                                                <div class="form-group row sinfo" data-name="DpUVfNzz">
                                                                    ...
                                                                    <div class="col-md-12" data-name="RcNVwlfU">
                                                                        <label class="col-form-label">{{trans('common.label.sender_info')}}
                                                                                {!! popover( 'common.label.sender_info_help','common.label.sender_info' ) !!}
                                                                        </label>
                                                                        <div class="kt-radio-inline" data-name="CLJDTAaU">
                                                                ...
                                                                <div class="form-group row" id="from_option_list" data-name="uslAMQMc">
                                                                    <label class="col-form-label col-md-4" for="from_name_list">{{trans('schedule_broadcast.add_new.tab4.form.choose_from_name_as_listed_in_list')}}</label>
                                                                    <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                                                        <label>
                                                                ...
                                                                <div class="form-group row" id="from_option_smtp" data-name="UvaRFpDP">
                                                                    <label class="col-form-label col-md-4" for="from_name_smtp">{{trans('schedule_broadcast.add_new.tab4.form.choose_from_name_as_listed_in_smtp')}}</label>
                                                                    <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                                                        <label>
                                                                    ...
                                                                    <div class="col-md-12" id="from_name" style="display: none;" data-name="cPFIQlNJ">
                                                                        <label class="col-form-label">{{trans('common.label.from_name')}}
                                                                                {!! popover('common.label.from_name_help','common.label.from_name') !!}
                                                                        </label>
                                                                    ...
                                                                    <div class="form-group row" data-name="qDPPwOrF">
                                                                        ...
                                                                        <div class="col-md-12" data-name="cZfffBLK">
                                                                            <label class="col-form-label">{{trans('common.label.from_email')}}
                                                                                 {!! popover('common.label.from_email_help','common.label.from_email') !!}
                                                                            </label>
                                                                            <?php 
                                                                                $form_email_part1 = "";
                                                                                $form_email_part2 = "";
                                                                            ...
                                                                            <div class="row from-email" data-name="KNkbhfBy">
                                                                                ...
                                                                                <div class="col-md-7" data-name="myHAqkat">
                                                                                    <select class="form-control m-select2" data-placeholder="Choose Email Domain" name="from_email_part2">
                                                                                        ...
                                                                                        ?>
                                                                                        @foreach($domain_maskings as $domain)
                                                                                            @include('common.domain_list_smtp_1' , compact("domain" , "unauth_sending_domain"));
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                                                            </div>        
                                                                    ...
                                                                    <div class="form-group row" data-name="MXwHOeVK">
                                                                        ...
                                                                        <div class="col-md-12" data-name="cNCyqCTN">
                                                                            <label class="col-form-label">{{trans('common.label.bounce_email')}}
                                                                                 {!! popover('common.label.bounce_email_help','common.label.bounce_email') !!}
                                                                            </label>
                                                                    ...
                                                                    <div class="form-group row" data-name="yOAjAXMR">
                                                                        ...
                                                                        <div class="col-md-12" data-name="HVnuUxyh">
                                                                            <label class="col-form-label">{{trans('common.label.reply_email')}}
                                                                                 {!! popover('common.label.reply_email_help','common.label.reply_email') !!}
                                                                            </label>
                                                        ...
                                                        <div class="form-group row" data-name="xxcDpkjO"> 
                                                            <label class="col-form-label text-left col-md-4" for="overwrite_subject"> {{trans('broadcasts.schedule_blade.schedule_again_button')}}
                                                            </label>
                                                            <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                                                <label>
    ...
    <div class="modal-dialog" role="document" data-name="fCSxiYPk">
        <div class="modal-content" data-name="EpJbwwzL">
            <div class="modal-body text-center" data-name="kijgpudz">
                ...
                <p class="text-center">{{trans('broadcasts.schedule_blade.scheduling_broadcast_para')}}</p>
