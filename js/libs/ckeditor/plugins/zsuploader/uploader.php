...
$upload_folder="/js/libs/ckeditor/plugins/zsuploader/images/";
...
<div class="bgColor" style="background-color: #2b3643;" width="100%">
<form id="uploadForm" action="upload.php" method="post">
<div id="targetLayer"><img id="output_image" alt="No Image" style="max-width:150px;" src="images/thumbs/default-image.jpg"/>
</div> 
<img src="images/thumbs/logo.png" alt="ZmajSoft Logo" style="width:auto;height:auto;margin-top:50px;;float:right;">  
