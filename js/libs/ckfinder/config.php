...
try {
        ...
        if(!empty($_COOKIE['sid']))
            $user_id = explode('_',$_COOKIE['sid'])[0];
}
...
$config['authentication'] = function () use($user_id) {
...
$config['licenseName'] = 'mumara-laravel.live';
$config['licenseKey']  = '*B?D-*1**-N**W-*P**-*7**-A*T*-4**K';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => "/storage/users/$user_id/media/",
...
$config['tempDirectory'] = createTempDir();
